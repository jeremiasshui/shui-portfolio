...
const industryThemes: Record<string, {
    ...
    '19-outdoor': {
        ...
        text: 'text-lime-900',
        tabActive: 'bg-lime-600',
        tabHover: 'hover:bg-lime-100',
    },
    '20-bakery': {
        primary: '#D97706',
        secondary: '#B45309',
        ...
        tabActive: 'bg-yellow-600',
        tabHover: 'hover:bg-yellow-100',
    },
    '21-biotech': {
        primary: '#14B8A6',
        secondary: '#0D9488',
